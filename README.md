...
Now that you have experienced building a layout using `inline-block`.  Lets revisit the same HTML structure & refactor our first page with flex box module.  If you didn't finish yesterday's assignment, just start from scratch or use the solution code provided to you.
